...
badd +0 ~/piscine_nineteen/rush01/ex01/build_matrix.c
argglobal
%argdel
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 27 + 91) / 182)
exe 'vert 2resize ' . ((&columns * 154 + 91) / 182)
argglobal
balt ~/piscine_nineteen/rush01/ex01/build_matrix.c
let s:cpo_save=&cpo
set cpo&vim
...
keepjumps 17
normal! 0
lcd ~/piscine_nineteen/rush01
wincmd w
argglobal
if bufexists(fnamemodify("~/piscine_nineteen/rush01/ex01/build_matrix.c", ":p")) | buffer ~/piscine_nineteen/rush01/ex01/build_matrix.c | else | edit ~/piscine_nineteen/rush01/ex01/build_matrix.c | endif
balt ~/piscine_nineteen/rush01/ex01/build_matrix.c
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
